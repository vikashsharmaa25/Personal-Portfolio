  ...
  return (
    ...
    >
      <div className="flex md:flex-row flex-col md:items-end items-center md:mt-0 mt-10">
        <Image src={swag} alt="Hero Hand" width={100} height={100} />
        <h1 className="lg:text-6xl text-center sm:text-5xl text-3xl font-extrabold tracking-wide">
          Hello! I&apos;m <span className="text-yellow-500">Vikash Sharma</span>
        </h1>
      </div>
      <h1 className="sm:text-3xl text-[18px] my-5 text-center">
        A <span className="font-extrabold">{typedText}</span>
      </h1>
      <h1 className="sm:text-3xl text-xl">
        with{" "}
        <span className="md:py-1 py-[3px] md:px-5 px-3 md:text-2xl border-gray-700 border rounded-full text-yellow-500 font-bold bg-opacity-10 bg-gray-400">
          1+ Years
        </span>{" "}
        Experience
      </h1>
      <div className="mt-10 flex gap-4 items-center">
        ...
        >
          <button className="flex items-center gap-2 sm:py-[16px] py-1 px-3 sm:px-8 text-yellow-500 bg-[#FEB901] hover:bg-opacity-100 hover:text-black bg-opacity-5 sm:text-2xl rounded-full border border-yellow-400 font-semibold duration-150">
            <GoArrowDown />
            Resume
          </button>
        </a>
        <button
          ...
          className="sm:py-[16px] py-1 px-3 sm:px-8 bg-[#FEB901] hover:bg-opacity-5 hover:text-[#FEB901] text-black sm:text-2xl rounded-full border border-yellow-400 font-semibold duration-150"
        >
          Hire Me
        </button>
      </div>
